...
export default function ProblemSection() {
    return (
        <section className="bg-[#F2F1ED] text-[#111111] py-32 overflow-hidden">
            <div className="container mx-auto max-w-7xl px-6">
                ...
                >
                    {stats.map((s) => (
                        <motion.div
                            key={s.stat}
                            variants={item}
                            className="bg-white border border-[#E2E1DC] rounded-2xl p-8 flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow"
                        >
                            <div className="text-5xl font-black text-[#E63946]">{s.stat}</div>
                ...
                {/* IS / IS NOT comparison — full-width side-by-side table */}
                <motion.div
