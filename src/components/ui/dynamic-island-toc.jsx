...
export function DynamicIslandTOC({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-[30px] left-0 right-0 z-[9999] flex justify-center items-end pointer-events-none">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="overflow-hidden relative border shadow-2xl border-foreground/10 bg-background text-foreground"
        >
          {/* CLOSED PILL CONTENT */}
          <motion.div
            initial={false}
          ...
          >
            ...
            <div className="flex overflow-hidden relative flex-1 items-center h-full text-left">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  ...
                  className="block overflow-hidden w-full text-sm font-medium whitespace-nowrap text-ellipsis text-foreground"
                >
          ...
          >
            ...
            <div className="overflow-y-auto overscroll-contain flex-1 px-3 pb-4" data-lenis-prevent="true">
              <div className="flex flex-col gap-0.5">
                {headings.map((h) => {
                  ...
                  return (
                    ...
                    >
                      <span className="overflow-hidden flex-1 whitespace-nowrap transition-transform duration-300 text-ellipsis group-hover:translate-x-1">
                        {h.text}
                      </span>
